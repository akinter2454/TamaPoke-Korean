...
#define SAVE_MIN_IMPORT_VERSION 1
#define SAVE_HDR 8
// Serial EXPORT/IMPORT working buffer. 8 KiB leaves headroom for the generated
// extended Pokedex/research blobs plus Digimon progress on ESP32-S3 builds.
#define SAVE_SERIAL_CAP 8192
